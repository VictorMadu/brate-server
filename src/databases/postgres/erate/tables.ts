...
export const TransferTransactions = {
    $$NAME: 'transfer_transactions' as 'transfer_transactions',
    from_transaction_id: 'from_transaction_id' as 'from_transaction_id',
    to_transaction_id: 'to_transaction_id' as 'to_transaction_id',
};

export const HeadTransactions = {
    $$NAME: 'head_transactions' as 'head_transactions',
    user_id: 'user_id' as 'user_id',
    transaction_id: 'transaction_id' as 'transaction_id',
    currency_id: 'currency_id' as 'currency_id',
};
