...
export class DbService {
  ...
  async storeCurrencyName(inData: Record<string, string>) {
    return await this.runner.runQuery(async (psql) => await this._storeCurrencyName(psql, inData));
  }

  private async _storeCurrencyName(psql: PoolClient, inData: Record<string, string>) {
