...
DROP FUNCTION IF EXISTS clean_delete_notification_list_test_set_up;

CREATE FUNCTION clean_delete_notification_list_test_set_up() RETURNS VOID 
AS $$
DECLARE
...
SELECT clean_delete_notification_list_test_set_up();