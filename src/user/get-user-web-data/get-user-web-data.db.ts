    ...
    getQuery() {
      ...
      SELECT 
        ...
        ${this.addFieldIfShouldInclude(
            ...
            this.include_remove_fund_notification_after,
            this.includeCommaIfAnyTrue(this.include_bereau_de_change, this.include_dark_mode)
        )}
        ...
        ${this.addFieldIfShouldInclude(
            ...
            "bereau_de_change",
            this.include_bereau_de_change,
            this.includeCommaIfAnyTrue(this.include_dark_mode)
        )}
