import { HttpController, Schema, Put, Headers, Body, Send } from "victormadu-nist-fastify-adapter";
import { STAR_FAVOURITE } from "../_constants/routes";
import { Service } from "./star-favourite.service";
...
export class Controller {
    ...
    async route(@Headers() headers: ReqHeaders, @Body() body: ReqBody, @Send() send: ResSend) {
        const [code, msg, payload] = await this.service.handle({
            ...
            currency_pairs: this.getItemAsArr(body.currency_pairs),
        });
